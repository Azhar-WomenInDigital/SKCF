                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td class="icon-list-demo text-center">
                        <a href="#"><i class="zmdi zmdi-edit zmdi-sm"></i></a>
                        <a href="#"><i class="zmdi zmdi-eye"></i></a>
                        <button type="button" onclick="deleteifno({{ $data->id }})">
                          <i class="zmdi zmdi-delete"></i>
                        </button>
                        <form id="delete-form-{{ $data->id }}" action="{{ route('admin.table.delete', $data->id) }}" method="POST" style="display: none;">
                          @csrf
                          @method('DELETE')
                        </form>
                      </td>  
