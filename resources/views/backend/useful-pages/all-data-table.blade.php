...
@section('page-title','All data table||data-table, responsive-data-table,')
@push('page-css')
<!-- DataTables -->
...
<link href="{{ asset('asset/backend/plugins/datatables/responsive.bootstrap4.min.css') }}" rel="stylesheet" type="text/css" />
<!-- Multi Item Selection examples -->
<link href="{{ asset('asset/backend/plugins/datatables/select.bootstrap4.min.css') }}" rel="stylesheet" type="text/css" />
@endpush
@section('page-content')
          ...
          <div class="row">
              <div class="col-xl-12">
                  <div class="page-title-box">
                      <h4 class="page-title float-left">Data Table</h4>
  ...
  <!-- End Button Dtata Table  -->

  <!-- KEYTABLE  Dtata Table  -->
  <div class="container-fluid">
    <div class="row">
        <div class="col-12">
            <div class="card-box">
  ...
  <!-- End KEYTABLE  Dtata Table  -->

  
  <!-- Responsive Dtata Table  -->
  <div class="container-fluid">
    <div class="row">
        <div class="col-12">
  ...
  <!-- End Responsive Dtata Table  -->


  <!-- Multi Selection  Dtata Table  -->
  <div class="container-fluid">
    <div class="row">
        <div class="col-12">
            <div class="card-box table-responsive">
  ...
  <!-- End Multi Selection  Dtata Table  -->
...
<!-- All Data-Table Implements Script -->
<script>
